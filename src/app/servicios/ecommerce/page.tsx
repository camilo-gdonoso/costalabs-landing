                            ...
                            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                                ...
                                <Box sx={{ display: 'flex', gap: 2 }}>
                                    ...
                                    <Box>
                                        ...
                                        <Typography sx={{ color: '#a1a1aa', fontSize: '0.9rem' }}>Crearemos una hoja de ruta para posicionar tus palabras clave, tal como lo hacemos en <strong>CostaLabs</strong> y <strong>Tierra Producciones</strong>.</Typography>
                                    </Box>
                                </Box>
                            </Box>
                        </Box>
